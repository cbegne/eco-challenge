...
export const ChallengeFinalStep = ({
  ...
  return (
    <FormContainer>
      ...
      <Subtext>On n’a plus qu’à attendre que Michel accepte :)</Subtext>
    </FormContainer>
  );
};
